...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_hero" ADD CONSTRAINT "pages_blocks_hero_image1_id_media_id_fk" FOREIGN KEY ("image1_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_hero" ADD CONSTRAINT "pages_blocks_hero_image2_id_media_id_fk" FOREIGN KEY ("image2_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_hero" ADD CONSTRAINT "pages_blocks_hero_image3_id_media_id_fk" FOREIGN KEY ("image3_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_hero_image1_idx" ON "pages_blocks_hero" USING btree ("image1_id");
  CREATE INDEX "pages_blocks_hero_image2_idx" ON "pages_blocks_hero" USING btree ("image2_id");
  CREATE INDEX "pages_blocks_hero_image3_idx" ON "pages_blocks_hero" USING btree ("image3_id");
